...
CUDA_VISIBLE_DEVICES=0 python src/Detect/create_detection_res.py --input_path DATA/image/cam_01 --output_path DATA/detection_result/cam_01_det.txt --model_path model_weights/Detect/Bright/output/model_final.pth
